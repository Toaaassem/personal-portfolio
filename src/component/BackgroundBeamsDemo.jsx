  ...
  return (
    <div className="h-[49rem] w-full bg-neutral-950 relative flex flex-col items-center justify-center antialiased">
      <div className="max-w-2xl mx-auto p-4">
        <h1 className="relative z-10 text-lg md:text-7xl sm:text-7xl  bg-clip-text text-transparent bg-gradient-to-b from-[#87CEEB] to-[#ff6fa0]  text-center font-sans font-bold">
        ...
        <div className=" flex flex-column justify-center">
          <button className="relative inline-flex h-10 overflow-hidden rounded-full p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50" onClick={() => scrollToSection("about")}>
